...
public class CeasarCipher {
    ...
    public void testCeasar() {
        ...
        String encrypted = encrypt("This message is just a test to decrypt method, it contains many eeeeeees, so it's easier to decript.", key);
    ...
    public void testEncryptTwoKeys() {
        ...
        System.out.println(encryptTwoKeys("This message is just a test to decrypt method, it contains many eeeeeees, so it's easier to decript", 8, 21));
